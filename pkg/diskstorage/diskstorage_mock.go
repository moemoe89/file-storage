...
func (m *GoMockDiskStorage) DownloadByte(ctx context.Context, targetURL string) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *GoMockDiskStorageMockRecorder) DownloadByte(ctx, targetURL interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DownloadByte", reflect.TypeOf((*GoMockDiskStorage)(nil).DownloadByte), ctx, targetURL)
}
