...
// GetFileStorageGatewayServer returns gRPC Gateway server instance for File Storage server.
func GetFileStorageGatewayServer() server.Server {
...
func (h *httpServer) Run() error {
	err := rpc.RegisterFileStorageServiceHandlerFromEndpoint(
		context.Background(),
		h.mux,
